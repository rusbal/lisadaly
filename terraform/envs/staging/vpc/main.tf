...
resource "aws_network_interface" "eni1" {
  subnet_id = module.terraform-aws-vpc.subnet_ids[0]
  tags      = local.tags
}

resource "aws_network_interface" "eni2" {
  subnet_id = module.terraform-aws-vpc.subnet_ids[1]
  tags      = local.tags
}
...
resource "aws_nat_gateway" "nat1" {
  ...
  subnet_id     = module.terraform-aws-vpc.subnet_ids[0]
  tags          = local.tags
  #depends_on    = [module.terraform-aws-vpc.aws_internet_gateway.gw]
}
